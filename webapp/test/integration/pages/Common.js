sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/prego/test/mobileHybridCRUD/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#mobileHybridCRUD-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#mobileHybridCRUD-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.prego.test.mobileHybridCRUD.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/prego/test/mobileHybridCRUD/localService/mockserver"], function (mockserver) {
