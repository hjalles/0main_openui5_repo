sap.ui.define([
	...
	return BaseObject.extend("com.prego.test.mobileHybridCRUD.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.prego.test.mobileHybridCRUD.model.ListSelector
		 */
		 ...
		 * @return {com.prego.test.mobileHybridCRUD.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
